...
@Component
public class RewardWebClient {

  private final BaseWebClient webClient;
  private final String basePath;
  private final String bearer;

  public RewardWebClient(
    BaseWebClient webClient,
    @Value("${driven-adapter.airtable.reward.base-path}") String basePath,
    @Value("${driven-adapter.airtable.reward.bearer}") String bearer
  ) {
