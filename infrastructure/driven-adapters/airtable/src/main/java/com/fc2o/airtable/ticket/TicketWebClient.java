...
import com.fc2o.airtable.ticket.dto.RecordDto;
import com.fc2o.airtable.ticket.dto.WrapperDto;
...
public class TicketWebClient {
  ...
  public TicketWebClient(
    BaseWebClient webClient,
    @Value("${driven-adapter.airtable.ticket.base-path}") String basePath,
    @Value("${driven-adapter.airtable.ticket.bearer}") String bearer
  ) {
